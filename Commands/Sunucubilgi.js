...
module.exports.execute = (client, message, args, ayar, emoji) => {
  ...
  const embed = new MessageEmbed().setTimestamp().setColor(client.randomColor()).setAuthor(message.guild.name, message.guild.iconURL({ dynamic: true })).setFooter("Glosha ❤️")
